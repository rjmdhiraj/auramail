...
// Understands user intent from natural speech in English, Hindi, and Hinglish
...
const NLU = {
    ...
    intents: {
        ...
        read_inbox: {
            ...
            patterns: {
                ...
                hinglish: [/inbox\s*(kholo|padho|dikhao|kholna)/i, /email\s*(padho|dikhao|batao)/i, /mere?\s*email\s*(dikhao|padho|batao|sunao)/i, /naye?\s*email/i, /mail\s*(padho|dikhao)/i]
            }
        },
        compose_email: {
            action: 'showCompose',
            patterns: {
                ...
                hinglish: [/(?:naya|nayi|ek|new)?\s*email\s*(likho|likhe|banao|likh)/i, /email\s*(likhna|bhejana)\s*(hai|chahta|chahti)/i, /(?:naya|new)\s*(?:mail|message)\s*(likho|banao)/i, /mujhe\s*email\s*(likhna|bhejna)/i]
            }
        },
        show_settings: {
            action: 'showSettings',
            patterns: {
                ...
                hinglish: [/settings?\s*(kholo|dikhao|badlo|open\s*karo)/i, /meri?\s*settings/i]
            }
        },
        go_back: {
            action: 'navigateBack',
            patterns: {
                ...
                hinglish: [/wapas\s*(jao|chalo|ja)/i, /peeche\s*(jao|ja)/i, /back\s*(jao|ja|karo)/i]
            }
        },
        show_help: {
            action: 'showHelp',
            patterns: {
                ...
                hinglish: [/madad/i, /help\s*karo/i, /kya\s*bol\s*sakta/i, /kaise\s*(kare|bole)/i]
            }
        },
        logout: {
            action: 'logout',
            patterns: {
                ...
                hinglish: [/log\s*out\s*(karo)?/i, /logout\s*(karo)?/i, /bahar\s*(niklo|jao)/i]
            }
        },
        sign_in: {
            ...
            patterns: {
                ...
                hinglish: [/sign\s*in\s*(karo)?/i, /login\s*(karo)?/i]
            }
        },
        ...
        switch_to_sent: {
            ...
            patterns: {
                ...
                hinglish: [/sent\s*(dikhao|kholo|padho|wale)/i, /bheje?\s*(gaye|huye)?\s*(dikhao|kholo)/i]
            }
        },
        switch_to_drafts: {
            action: 'switchFolder',
            ...
            patterns: {
                ...
                hinglish: [/drafts?\s*(dikhao|kholo|padho)/i]
            }
        },
        switch_to_spam: {
            action: 'switchFolder',
            ...
            patterns: {
                ...
                hinglish: [/spam\s*(dikhao|kholo|padho)/i]
            }
        },
        ...
        read_email: {
            ...
            patterns: {
                ...
                hinglish: [/(?:ye|yeh|is)?\s*(?:email|mail)\s*(padho|sunao|bolo)/i, /zor\s*se\s*padho/i, /email\s*(?:read|padh)\s*(?:karo|kar|do)/i]
            }
        },
        open_email_number: {
            ...
            patterns: {
                ...
                hinglish: [/(?:email|mail)?\s*(?:number)?\s*(\d+)\s*(kholo|padho|dikhao|open\s*karo)/i, /(\w+)\s*(?:wala|wali|number)?\s*(?:email|mail)\s*(kholo|padho|dikhao)/i, /(?:email|mail)\s*(\w+)\s*(kholo|padho)/i]
            }
        },
        reply_email: {
            action: 'replyToEmail',
            patterns: {
                ...
                hinglish: [/reply\s*(karo|kar\s*do|de\s*do)/i, /(?:iska)?\s*jawab\s*(do|de|likho|bhejo)/i, /respond\s*(karo)/i]
            }
        },
        forward_email: {
            action: 'forwardEmail',
            patterns: {
                ...
                hinglish: [/forward\s*(karo|kar\s*do)/i, /(?:ise|ye)?\s*(?:aage\s*bhejo)/i]
            }
        },
        delete_email: {
            ...
            patterns: {
                ...
                hinglish: [/delete\s*(karo|kar\s*do)/i, /(?:ise|ye)?\s*(hatao|hata\s*do)/i, /trash\s*(?:me|mein)\s*(dalo|bhejo)/i]
            }
        },
        mark_spam: {
            action: 'markAsSpam',
            ...
            patterns: {
                ...
                hinglish: [/spam\s*(karo|mark\s*karo|bana\s*do)/i, /(?:ye|yeh)\s*spam\s*hai/i]
            }
        },
        ...
        start_dictation: {
            ...
            patterns: {
                ...
                hinglish: [/bolna\s*(shuru\s*karo|start\s*karo)/i, /dictation\s*(shuru|start|chalu)\s*(karo)?/i, /voice\s*(type|input)\s*(karo|shuru)/i]
            }
        },
        stop_dictation: {
            ...
            patterns: {
                ...
                hinglish: [/bolna\s*(band\s*karo|rok|stop\s*karo)/i, /dictation\s*(band|stop|roko)\s*(karo)?/i]
            }
        },
        dictate_recipient: {
            ...
            patterns: {
                ...
                hinglish: [/recipient\s*(bolo|batao|likho)/i, /kisko?\s*bhejna\s*(hai)?/i, /email\s*kis\s*ko/i]
            }
        },
        dictate_subject: {
            ...
            patterns: {
                ...
                hinglish: [/subject\s*(bolo|batao|likho)/i, /vishay\s*(bolo|batao|likho)/i]
            }
        },
        dictate_message: {
            ...
            patterns: {
                ...
                hinglish: [/message\s*(bolo|likho|type\s*karo)/i, /(?:mujhe)?\s*message\s*(likhna|bolna)\s*(hai)?/i, /sandesh\s*(bolo|likho)/i]
            }
        },
        ...
        send_email: {
            ...
            patterns: {
                ...
                hinglish: [/(?:ye|yeh|ise)?\s*(?:email|mail)?\s*bhejo/i, /bhej\s*do/i, /email\s*send\s*(karo|kar\s*do)/i]
            }
        },
        confirm_send: {
            action: 'sendEmail',
            patterns: {
                ...
                hinglish: [/confirm\s*(karo|kar\s*do)/i, /bhejne\s*ki\s*pushti/i, /haan\s*bhej\s*do/i]
            }
        },
        save_draft: {
            ...
            patterns: {
                ...
                hinglish: [/draft\s*(save\s*karo|bacha|rakh\s*lo)/i, /save\s*(karo|kar\s*do)\s*draft/i]
            }
        },
        ...
        toggle_dark_mode: {
            ...
            patterns: {
                ...
                hinglish: [/dark\s*mode\s*(karo|lagao|chalu|on|off|band)/i, /light\s*mode\s*(karo|lagao|chalu)/i, /(?:andhera|raat)\s*(?:mode|wala)/i, /night\s*mode/i]
            }
        },
        toggle_contrast: {
            ...
            patterns: {
                ...
                hinglish: [/high\s*contrast\s*(karo)?/i, /contrast\s*(badhao|toggle\s*karo)/i]
            }
        },
        increase_volume: {
            ...
            patterns: {
                ...
                hinglish: [/(?:awaaz|awaz|volume)\s*(badhao|upar\s*karo|badha\s*do)/i, /zor\s*se\s*bolo/i, /sunai\s*nahi/i, /volume\s*(up|increase)\s*(karo)?/i]
            }
        },
        decrease_volume: {
            ...
            patterns: {
                ...
                hinglish: [/(?:awaaz|awaz|volume)\s*(kam\s*karo|neeche\s*karo|dhimi\s*karo)/i, /dheere?\s*(?:bolo|se)/i, /volume\s*(down|decrease|kam)\s*(karo)?/i]
            }
        },
        increase_font: {
            ...
            patterns: {
                ...
                hinglish: [/(?:font|text)\s*(bada|bade)\s*(karo|kar\s*do)/i, /bada\s*(?:text|likho)/i, /(?:dikhai|padh)\s*nahi\s*(deta|de\s*raha)/i, /font\s*(size)?\s*(badhao|increase\s*karo)/i]
            }
        },
        repeat_last: {
            ...
            patterns: {
                ...
                hinglish: [/dobara\s*(bolo|batao)/i, /phir\s*se\s*bolo/i, /(?:kya|wo)\s*(?:bola|kaha)/i, /samajh\s*nahi\s*aaya/i, /sunai\s*nahi\s*diya/i, /repeat\s*(karo)?/i]
            }
        },
        ...
        switch_to_hindi: {
            ...
            patterns: {
                ...
                hinglish: [/hindi\s*(?:mein|me|mai)?\s*(bolo|karo|switch\s*karo)/i]
            }
        },
        switch_to_english: {
            action: 'switchLanguage',
            ...
            patterns: {
                ...
                hinglish: [/english\s*(?:mein|me|mai)?\s*(bolo|karo|switch\s*karo)/i, /angrezi\s*(?:mein|me)?\s*(bolo|karo)/i]
            }
        },
        ...
        refresh: {
            ...
            patterns: {
                ...
                hinglish: [/refresh\s*(karo)?/i, /(?:naye?)?\s*email\s*(lao|check\s*karo|dekho)/i, /reload\s*(karo)?/i]
            }
        },
    },
    ...
    numberWords: {
        ...
        hinglish: { pehla: 1, pehli: 1, doosra: 2, doosri: 2, teesra: 3, teesri: 3, chautha: 4, chauthi: 4, paanchwa: 5, chhata: 6, saatwa: 7, aathwa: 8, nauwa: 9, daswa: 10, aakhri: -1, last: -1 }
    },
    ...
    understand(text, lang = 'en-US') {
        ...
        // Search order: primary language first, then hinglish (always), then other
        const searchLangs = langPrefix === 'hi'
            ? ['hi', 'hinglish', 'en']
            : ['en', 'hinglish', 'hi'];
            ...
            for (const searchLang of searchLangs) {
                ...
                for (const pattern of patterns) {
                    ...
                    if (match) {
                        ...
                        // Primary language gets highest boost, hinglish always gets a good boost
                        const langBoost = searchLang === searchLangs[0] ? 0.1
                            : searchLang === 'hinglish' ? 0.08 : 0;
    ...
    /**
     * Extract a number from text (digit or word form, including Hinglish)
     */
    _extractNumber(text, langPrefix) {
        ...
        // Try word-based number (all languages including hinglish)
        const words = { ...this.numberWords.en, ...this.numberWords.hi, ...this.numberWords.hinglish };
